...
import com.hzwydyj.finace.fragments.News_Detail_Fragment;
 ...
 *
 */
public class NewsDetailView_ViewPager extends FragmentActivity {
	...
	class HD_priceView_Global_FragmentPagerAdapter extends FragmentPagerAdapter {
		...
		public Fragment getItem(int position) {
			Fragment fragment = new News_Detail_Fragment();
			Bundle args = new Bundle();
			args.putString("link", Const.URL_NEWS_PREFIX + newsData.get(position));
