...
public class DriectListView extends ListView implements OnScrollListener {
	...
	// -- header view
	private PointListViewHeader mHeaderView;
	 ...
	 * @param context
	 */
	public DriectListView(Context context) {
		super(context);
		initWithContext(context);
	}

	public DriectListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initWithContext(context);
	}

	public DriectListView(Context context, AttributeSet attrs, int defStyle) {
	...
	private void initWithContext(Context context) {
		...
		// init header view
		mHeaderView = new PointListViewHeader(context);
